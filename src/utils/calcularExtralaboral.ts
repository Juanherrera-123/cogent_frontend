import {
  ...
  factorGlobalExtralaboral,
  baremosTotalA,
  baremosTotalB
} from "../data/esquemaExtralaboral";
...
export function calcularExtralaboral(
  respuestas: string[], // array de respuestas, índice base 0
  tipoForma: "A" | "B"
) {
  ...
  if (puntajeTransformadoTotal < 0) puntajeTransformadoTotal = 0;
  if (puntajeTransformadoTotal > 100) puntajeTransformadoTotal = 100;
